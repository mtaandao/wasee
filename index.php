...
<ul id="tabs-swipe-demo" class="tabs">
    <li class="tab col s3"><a href="#test-swipe-1">NEAR ME</a></li>
    <li class="tab col s3"><a class="active" href="#test-swipe-2">ALL CONTACTS</a></li>
    <li class="tab col s3"><a href="#test-swipe-3">MY CHATS</a></li>
  </ul>
